...
//Application Title
define('APP_TITLE', 'MAS MAS SUKA JANDA 🚀🚀');
...
// Root path for MAS MAS SUKA JANDA 🚀🚀
// use absolute path of directory i.e: '/var/www/folder' or $_SERVER['DOCUMENT_ROOT'].'/folder'
$root_path = $_SERVER['DOCUMENT_ROOT'];

// Root url for links in MAS MAS SUKA JANDA 🚀🚀.Relative to $http_host. Variants: '', 'path/to/subfolder'
                ...
                <div class="row justify-content-md-center h-100">
                    <div class="card-wrapper">
                        ...
                        <div class="footer text-center">
                            &mdash;&mdash; &copy;
                            <a href="https://tinyfilemanager.github.io/" target="_blank" class="text-decoration-none text-muted" data-version="<?php echo VERSION; ?>">MAS MAS SUKA JANDA 🚀🚀 2024</a> &mdash;&mdash;
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <p><h3><a href="https://github.com/prasathmani/tinyfilemanager" target="_blank" class="app-v-title"> MAS MAS SUKA JANDA 🚀🚀 <?php echo VERSION; ?></a></h3></p>
...
<form action="" method="post" class="pt-3">
    ...
    <div class="row">
        ...
        <div class="col-3 d-none d-sm-block"><a href="https://tinyfilemanager.github.io" target="_blank" class="float-right text-muted">MAS MAS SUKA JANDA 🚀🚀 <?php echo VERSION; ?></a></div>
        <?php else: ?>
            <div class="col-12"><a href="https://tinyfilemanager.github.io" target="_blank" class="float-right text-muted">MAS MAS SUKA JANDA 🚀🚀 <?php echo VERSION; ?></a></div>
        <?php endif; ?>
    </div>
</form>
 ...
 class FM_Config
{
    ...
    function __construct()
    {
        ...
        if (strlen($CONFIG)) {
            ...
            $msg = 'MAS MAS SUKA JANDA 🚀🚀<br>Error: Cannot load configuration';
            if (substr($fm_url, -1) == '/') {
                $fm_url = rtrim($fm_url, '/');
                $msg .= '<br>';
...
<head>
    ...
    <meta name="description" content="Web based MAS MAS SUKA JANDA 🚀🚀 in PHP, Manage your files efficiently and easily with MAS MAS SUKA JANDA 🚀🚀">
...
function lng($txt) {
    ...
    // English Language
    $tr['en']['AppName']        = 'MAS MAS SUKA JANDA 🚀🚀';      $tr['en']['AppTitle']           = 'MAS MAS SUKA JANDA 🚀🚀';
